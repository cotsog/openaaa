/*
 * $hash/fn.h                                       Daniel Kubec <niel@rtfm.cz>
 *
 ...
 *
 * Based o statically sized hash table implementation linux/hashtable.h
 *                              (C) 2012  Sasha Levin <levinsasha928@gmail.com>
 */

#ifndef __AAA_HASH_FN_H__
#define __AAA_HASH_FN_H__
