...
sys_uri_scheme_unregister(const char *id)
{
	...
	/*
	sys_call_trace(RegDeleteKeyEx, ERROR_SUCCESS, key, NULL, KEY_WOW64_32KEY | KEY_WOW64_64KEY, 0);
	sys_call_trace(RegDeleteKeyEx, ERROR_SUCCESS, key, NULL, KEY_WOW64_32KEY, 0);
	sys_call_trace(RegDeleteKeyEx, ERROR_SUCCESS, key, NULL, KEY_WOW64_64KEY, 0);
	*/
sys_error:
	if (key)
		RegCloseKey(key);
