...
/* Read 16-bit integer value from an unaligned sequence of 2 bytes */
static inline uint
get_u16_be(const void *p) { return *(u16 *)p; } 
/* Read 32-bit integer value from an unaligned sequence of 4 bytes */
static inline u32
get_u32_be(const void *p) { return *(u32 *)p; } 
/** Read 64-bit integer value from an unaligned sequence of 8 bytes */
static inline u64
get_u64_be(const void *p) { return *(u64 *)p; }
/** Write 16-bit integer value to an unaligned sequence of 2 bytes */
static inline void
put_u16_be(void *p, uint x) { *(u16 *)p = x; } 
/** Write 32-bit integer value to an unaligned sequence of 4 bytes */
static inline void
put_u32_be(void *p, u32 x) { *(u32 *)p = x; } 
/** Write 64-bit integer value to an unaligned sequence of 8 bytes */
static inline void
...
/*
 * Read 40-bit integer value from an unaligned sequence of 5 bytes 
 * (big-endian version). 
 */
...
/* Write 40-bit integer value to an unaligned sequence of 5 bytes */
static inline void
