...
typedef struct crc32_context {
	u32 state;
	void (*update_func)(struct crc32_context *ctx, const byte *buf, unsigned int len);
} crc32_context;
...
void
crc32_init(crc32_context *ctx, unsigned int crc_mode);
...
static inline void
crc32_update(crc32_context *ctx, const byte *buf, unsigned int len)
{
