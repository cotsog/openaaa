...
static void 
crc32_update_by1(crc32_context *ctx, const byte *buf, unsigned int len)
{
	u32 crc = ctx->state;
	while (len--)
...
static void crc32_update_by4(crc32_context *ctx, const byte *buf, unsigned int len)
{
...
static void crc32_update_by8(crc32_context *ctx, const byte *buf, unsigned int len)
{
...
u32
crc32_hash_buffer(const byte *buf, unsigned int len)
{
	crc32_context ctx;
