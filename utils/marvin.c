/* $ marvin.c                                    Daniel Kubec <niel@rtfm.cz */
...
static const char package_name[] = "marvin";
...
usage(int code)
{
	...
	printf("\t--cpu-processes,-x\t\t\t number of processes\n");
	printf("\t--cpu-threads,  -y\t\t\t number of threads\n");
