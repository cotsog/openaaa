...
#define GARY_HDR_SIZE _align_to(sizeof(struct gary_hdr), CPU_STRUCT_ALIGN)
 ...
 **/
#define GARY_INIT(ptr, n) (ptr) = gary_init(sizeof(*(ptr)), (n), &allocator_std)

/**
 * Create a growing array like GARY_INIT() does, but all newly
 * allocated elements will be automatically zeroed.
 **/
#define GARY_INIT_ZERO(ptr, n) (ptr) = gary_init(sizeof(*(ptr)), (n), &allocator_zeroed)
...
/* Internal functions */
void *gary_init(size_t elt_size, size_t num_elts, struct allocator *allocator);
