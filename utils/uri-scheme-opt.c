/*
  ...
  gengetopt --include-getopt -i ./etc/scheme.ggo --file-name=./utils/uri-scheme-opt -f scheme -a scheme_args_info 
...
#include "./utils/uri-scheme-opt.h"

const char *scheme_args_info_purpose = "Daniel Kubec <niel@rtfm.cz>";

const char *scheme_args_info_usage = "Usage: uri-scheme [OPTIONS]...";

const char *scheme_args_info_description = "";

const char *scheme_args_info_help[] = {
  "  -h, --help            Print help and exit",
  "  -V, --version         Print version and exit",
  "\nuri::scheme:",
  "  -n, --name=STRING     uri::scheme name",
  "  -x, --handler=STRING  uri::scheme handler ",
  "  -a, --about=STRING    uri::scheme about",
  "  -l, --list            uri::scheme list",
  "  -r, --register        uri::scheme register",
  "  -u, --unregister      uri::scheme unregister",
    0
};
...
static
void clear_given (struct scheme_args_info *args_info);
static
void clear_args (struct scheme_args_info *args_info);

static int
scheme_internal (int argc, char **argv, struct scheme_args_info *args_info,
                        struct scheme_params *params, const char *additional_error);

static int
scheme_required2 (struct scheme_args_info *args_info, const char *prog_name, const char *additional_error);
...
void clear_args (struct scheme_args_info *args_info)
{
  ...
  args_info->handler_arg = NULL;
  args_info->handler_orig = NULL;
  args_info->about_arg = NULL;
  args_info->about_orig = NULL;
  
}

static
void init_args_info(struct scheme_args_info *args_info)
{


  args_info->help_help = scheme_args_info_help[0] ;
  args_info->version_help = scheme_args_info_help[1] ;
  args_info->name_help = scheme_args_info_help[3] ;
  args_info->handler_help = scheme_args_info_help[4] ;
  args_info->about_help = scheme_args_info_help[5] ;
  args_info->list_help = scheme_args_info_help[6] ;
  args_info->register_help = scheme_args_info_help[7] ;
  args_info->unregister_help = scheme_args_info_help[8] ;
  
}

void
scheme_print_version (void)
{
  printf ("%s %s\n",
     (strlen(SCHEME_PACKAGE_NAME) ? SCHEME_PACKAGE_NAME : SCHEME_PACKAGE),
     SCHEME_VERSION);
}

static void print_help_common(void) {
  scheme_print_version ();

  if (strlen(scheme_args_info_purpose) > 0)
    printf("\n%s\n", scheme_args_info_purpose);

  if (strlen(scheme_args_info_usage) > 0)
    printf("\n%s\n", scheme_args_info_usage);

  printf("\n");

  if (strlen(scheme_args_info_description) > 0)
    printf("%s\n\n", scheme_args_info_description);
}

void
scheme_print_help (void)
{
  int i = 0;
  print_help_common();
  while (scheme_args_info_help[i])
    printf("%s\n", scheme_args_info_help[i++]);
}

void
scheme_init (struct scheme_args_info *args_info)
{
...
void
scheme_params_init(struct scheme_params *params)
{
  if (params)
    { 
      params->override = 0;
...
scheme_params_create(void)
{
  struct scheme_params *params = 
    (struct scheme_params *)malloc(sizeof(struct scheme_params));
...
static void
scheme_release (struct scheme_args_info *args_info)
{

  free_string_field (&(args_info->name_arg));
  free_string_field (&(args_info->name_orig));
  free_string_field (&(args_info->handler_arg));
  free_string_field (&(args_info->handler_orig));
  free_string_field (&(args_info->about_arg));
  free_string_field (&(args_info->about_orig));
...
int
scheme_dump(FILE *outfile, struct scheme_args_info *args_info)
{
  int i = 0;
  ...
  if (args_info->handler_given)
    write_into_file(outfile, "handler", args_info->handler_orig, 0);
  if (args_info->about_given)
    write_into_file(outfile, "about", args_info->about_orig, 0);
  if (args_info->list_given)
    write_into_file(outfile, "list", 0, 0 );
  if (args_info->register_given)
    write_into_file(outfile, "register", 0, 0 );
  if (args_info->unregister_given)
    write_into_file(outfile, "unregister", 0, 0 );
...
int
scheme_file_save(const char *filename, struct scheme_args_info *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  if (!outfile)
    {
      fprintf (stderr, "%s: cannot open file for writing: %s\n", SCHEME_PACKAGE, filename);
      return EXIT_FAILURE;
    }

  i = scheme_dump(outfile, args_info);
  fclose (outfile);
...
void
scheme_free (struct scheme_args_info *args_info)
{
  scheme_release (args_info);
}
...
int
scheme (int argc, char **argv, struct scheme_args_info *args_info)
{
  return scheme2 (argc, argv, args_info, 0, 1, 1);
}

int
scheme_ext (int argc, char **argv, struct scheme_args_info *args_info,
                   struct scheme_params *params)
{
  int result;
  result = scheme_internal (argc, argv, args_info, params, 0);

  if (result == EXIT_FAILURE)
    {
      scheme_free (args_info);
      exit (EXIT_FAILURE);
    }
...
int
scheme2 (int argc, char **argv, struct scheme_args_info *args_info, int override, int initialize, int check_required)
{
  int result;
  struct scheme_params params;
...
int
scheme_required (struct scheme_args_info *args_info, const char *prog_name)
{
  int result = EXIT_SUCCESS;

  if (scheme_required2(args_info, prog_name, 0) > 0)
    result = EXIT_FAILURE;
...
scheme_required2 (struct scheme_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (args_info->handler_given && ! args_info->name_given)
    {
      fprintf (stderr, "%s: '--handler' ('-x') option depends on option 'name'%s\n", prog_name, (additional_error ? additional_error : ""));
      error = 1;
    }
  if (args_info->about_given && ! args_info->handler_given)
    {
      fprintf (stderr, "%s: '--about' ('-a') option depends on option 'handler'%s\n", prog_name, (additional_error ? additional_error : ""));
      error = 1;
    }
  if (args_info->register_given && ! args_info->about_given)
    {
      fprintf (stderr, "%s: '--register' ('-r') option depends on option 'about'%s\n", prog_name, (additional_error ? additional_error : ""));
      error = 1;
    }
  if (args_info->unregister_given && ! args_info->name_given)
    {
      fprintf (stderr, "%s: '--unregister' ('-u') option depends on option 'name'%s\n", prog_name, (additional_error ? additional_error : ""));
      error = 1;
    }
 ...
 * @param check_ambiguity @see scheme_params.check_ambiguity
 * @param override @see scheme_params.override
...
int
scheme_internal (
  int argc, char **argv, struct scheme_args_info *args_info,
                        struct scheme_params *params, const char *additional_error)
{
  int c;	/* Character of the parsed option.  */

  int error = 0;
  struct scheme_args_info local_args_info;
  ...
  if (initialize)
    scheme_init (args_info);

  scheme_init (&local_args_info);
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVn:x:a:lru", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'n':	/* uri::scheme name.  */
          ...
          break;
        case 'x':	/* uri::scheme handler .  */
        
        
          if (update_arg( (void *)&(args_info->handler_arg), 
               &(args_info->handler_orig), &(args_info->handler_given),
              &(local_args_info.handler_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "handler", 'x',
              additional_error))
            goto failure;
          ...
          break;
        case 'a':	/* uri::scheme about.  */
        
        
          if (update_arg( (void *)&(args_info->about_arg), 
               &(args_info->about_orig), &(args_info->about_given),
              &(local_args_info.about_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "about", 'a',
              additional_error))
            goto failure;
        ...
        case 'r':	/* uri::scheme register.  */
          ...
          break;
        case 'u':	/* uri::scheme unregister.  */
        
        
          if (update_arg( 0 , 
               0 , &(args_info->unregister_given),
              &(local_args_info.unregister_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "unregister", 'u',
              additional_error))
            goto failure;
        ...
        default:	/* bug: option not considered.  */
          fprintf (stderr, "%s: option unknown: %c%s\n", SCHEME_PACKAGE, c, (additional_error ? additional_error : ""));
          abort ();
        } /* switch */
    } /* while */
  ...
  if (check_required)
    {
      error += scheme_required2 (args_info, argv[0], additional_error);
    }

  scheme_release (&local_args_info);
